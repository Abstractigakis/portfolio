...
const PageLoading: FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`absolute transition-opacity ease-in duration-300 inset-0 ${
          loading ? "opacity-100 z-100" : "opacity-0 -z-100"
        }`}
      >
        <div className="bg-black bg-opacity-50 absolute inset-0 grid place-items-center">
          <svg
            role="status"
            className="inline w-12 h-12 text-gray-600 animate-spin "
            viewBox="0 0 100 101"
