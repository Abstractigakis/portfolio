...
export default function Model({ ...props }) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/models/Joey/joey.glb");
      ...
      <group name="Scene">
        ...
        <group name="Armature" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          ...
          <skinnedMesh
            ...
            material={materials["Eyes_MAT.002"]}
...
useGLTF.preload("/models/Joey/joey.glb");
